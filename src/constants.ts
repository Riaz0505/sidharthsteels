...
export const SITE_NAME = "Sidharth Steels";
export const TAGLINE = "Trusted Stainless Steel Dealer & Stockist in Chennai";
...
export const INDUSTRIES_DETAILED = [
  {
    ...
    description: "Supplying structural steel for modern facades, roofing, and structural frameworks in South India's booming real estate.",
    icon: "Building2"
  },
  {
    name: "Automotive & Transport",
    description: "Providing high-heat resistant alloys for exhaust systems and decorative trims for major manufacturers.",
    icon: "Car"
  },
  {
    name: "Chemical & Petrochemical",
    description: "Corrosion-resistant grades like 316L and 904L for storage tanks, reactors, and pressure vessels.",
    icon: "FlaskConical"
  },
  {
    name: "Food & Beverage Processing",
    description: "Hygienic 304/316 grade sheets and tubes compliant with food safety standards for diaries and breweries.",
    icon: "Utensils"
  },
  {
    name: "Medical & Pharmaceuticals",
    description: "Precision micro-tubing and non-reactive sheets for surgical equipment and lab environments.",
    icon: "Stethoscope"
  },
  {
    name: "Power Generation",
    description: "Heat-resistant stainless steel for boilers, heat exchangers, and cooling systems in power plants.",
    icon: "Zap"
  }
];
...
export const BLOG_POSTS = [
  {
    id: 1,
    title: "Utilization of Stainless Steel in Modern Industries",
    slug: "utilization-of-stainless-steel",
    excerpt: "Discover why stainless steel remains the top choice for modern infrastructure and manufacturing across Chennai and South India...",
    date: "May 10, 2024",
    author: "Sidharth Expert",
    category: "Industrial Tech",
    content: `## The Backbone of Modern Industry

Stainless steel is more than just a material; it is the fundamental building block of modern industrial progress. In Chennai's rapidly growing industrial sectors, the demand for high-grade stainless steel has never been higher.

### Why Stainless Steel?
The primary reason for its widespread use is its exceptional resistance to corrosion. Whether in chemical processing plants or coastal construction projects, stainless steel stands the test of time.

### Key Applications:
1. **Construction**: Structural supports and aesthetic cladding.
2. **Automotive**: Exhaust systems and decorative trim.
3. **Medical**: Surgical instruments and orthopedic implants.

### Future Outlook
As we move towards more sustainable infrastructure, the recyclability of steel makes it the preferred material for green building initiatives in India.

At Sidharth Steels, we ensure that our supplies meet the rigorous 304 and 316 grade standards required for these high-stakes applications.`,
    image: p6,
  },
  {
    id: 2,
    title: "How Steel Improves Industrial Infrastructure",
    slug: "steel-industrial-infrastructure",
    excerpt: "Exploring the critical role of high-grade steel in building resilient and sustainable cities and factories...",
    date: "April 25, 2024",
    author: "Technical Team",
    category: "Infrastructure",
    content: `## Building the Future

Industrial infrastructure depends heavily on materials that offer both strength and versatility. High-grade steel provides the necessary structural integrity for massive engineering projects.

### Durability and Sustainability
Steel is 100% recyclable, making it one of the most sustainable materials in the construction industry. Our focus at Sidharth Steels is to provide materials that not only last for decades but also contribute to a greener future.

### Engineering Excellence
From the heavy-duty plates used in shipbuilding to the precision tubes in pharmaceutical plants, our inventory reflects the diverse needs of South India's industrial hub.

### Logistics and Supply
Having a robust supply chain is as important as the material quality. Our proximity to the Chennai port allows us to manage large volumes with precision and speed.`,
    image: p7,
  },
  {
    id: 3,
    title: "Understanding 304 vs 316 Stainless Steel",
    slug: "304-vs-316-comparison",
    excerpt: "Crucial guide for engineers to choose between the two most popular grades of stainless steel...",
    date: "March 12, 2024",
    author: "Quality Analyst",
    category: "Technical Specs",
    content: `## 304 vs 316: Which Should You Use?

Choosing the right grade is critical for the longevity of your project. While 304 is the most common, 316 offers superior protection in specific environments.

### Grade 304 (The Workhorse)
- **Composition**: 18% chromium, 8% nickel.
- **Uses**: Kitchen equipment, household hardware, structural members.
- **Pros**: Excellent formability and weldability. Cost-effective.

### Grade 316 (The Coastal King)
- **Composition**: 16% chromium, 10% nickel, 2% molybdenum.
- **Uses**: Marine parts, chemical processing, medical instruments.
- **Pros**: Molybdenum adds resistance to chlorides (like salt water).

### Conclusion
For Chennai-based projects near the coast, 316 is often the better investment despite the higher price point due to its salt-mist resistance.`,
    image: p1,
  }
];

export const GALLERY_IMAGES = [p1, p2, p3, p4, p5, p6, p7];
